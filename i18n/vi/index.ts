export default {
  ...
  banner: {
    ...
    description: {
      descriptionOne: "Chúng tôi sẽ trở lại với một điều tuyệt vời. Để nhận các bản",
      descriptionTwo: "cập nhật mới nhất về trò chơi, vui lòng đăng ký nhận bản tin của chúng tôi."
    },
  ...
  ourGames: {
    ...
    gDragon: "G-Dragon",
    blueFire: "Blue Fire",
    egyptGame: "Egypt Game",
    descriptionGame: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua."
  },
  ourPartners: {
    title: "Đối tác"
  },
  contactUs: {
    address: "Địa chỉ",
    addressForeign: "Valletta Buildings, South Street, Valletta - VLT 1103 Malta, Mỹ",
    addressLocal: "Số 20 đường Phan Đăng Lưu, quận Hải Châu, thành phố Đà Nẵng, Việt Nam",
